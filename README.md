...
| [`grill-me-full`](skills/grill-me-full/SKILL.md) | Thorough interview to sharpen a request, plan, design, or prompt intent; ranks open decisions by expected value and continues until nothing further would change what the agent does. |
