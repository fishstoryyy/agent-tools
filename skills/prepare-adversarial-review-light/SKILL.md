...
4. Separate evidence and established facts from assumptions, interpretations, and incumbent conclusions. Focus criticism on real defects, material risks, consequential omissions, and plausible failure modes. Do not chase a finding count or elevate taste, cosmetic nits, harmless deviations, or remote hypotheticals. Include known failures and uncertainties without preselecting criticism or suggesting a verdict; state clearly when no material issue is found.
